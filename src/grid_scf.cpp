...
//		profiler_output(stdout);
		...
		if (opts().eos == WD) {
			params.struct_eos1->set_wd_T0(15000000, opts().atomic_mass[0], opts().atomic_number[0]);
			params.struct_eos2->set_wd_T0(15000000, opts().atomic_mass[3], opts().atomic_number[3]);
		...
		lprintf((opts().data_dir + "log.txt").c_str(),
				"%i %13e %13e %13e %13e %13e %13e %13e %13e %13e %13e %13e %13e %13e %13e  %13e %13e %13e %13e %13e %13e %13e\n", i, rho1, rho2, M1, M2, is1,
				is2, omega, virial, core_frac_1, core_frac_2, jorb, jmin, amin, j1 + j2 + jorb, com, spin_ratio, iorb, r0, r1, fi0, fi1);
		if (i % 10 == 0) {
